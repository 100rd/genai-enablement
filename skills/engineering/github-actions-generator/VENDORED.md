...
- **Skill:** `github-actions-generator` (registry path `engineering/github-actions-generator`)
- **Upstream:** `akin-ozer/cc-devops-skills` · path `devops-skills-plugin/skills/github-actions-generator`
- **Author:** akin-ozer
- **License:** Apache-2.0 (see `LICENSE`)
- **Vendored from:** monorepo `.claude/skills/github-actions-generator` (originally vendored from upstream 2026-06-10)
...
assets, examples, and references are unchanged.
