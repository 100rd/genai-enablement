...
# platform extension namespace (added on vendoring; upstream fields preserved):
# tier T3: body directs state-mutating cluster ops (kubectl apply to install ArgoCD, automated sync/prune/self-heal) — human approval required, not read-only.
version: 0.1.0
tags: [engineering, gitops, argocd, flux, kubernetes]
