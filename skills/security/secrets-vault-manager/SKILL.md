...
# tier T3: body directs state-mutating secret ops (rotation, token revocation, seal/unseal, vault write) — human approval required, not read-only.
version: 0.1.0
tags: [security, secrets, vault, rotation]
