...
RUNTIME_PROFILE_PINS = {
    "management-readonly-v1": {
        ...
        "barbarossa_go_scope": "complete-implemented-capability-surface",
    ...
    "barbarossa-ha-v1": {
        ...
        "barbarossa_go_scope": "complete-implemented-capability-surface",
        "barbarossa_typescript_role": "conformance-oracle-only",
        "barbarossa_work_transport": "nats-jetstream",
        "barbarossa_stream_replicas": 3,
        "barbarossa_state_store": "postgresql-ha",
        "delivery_semantics": "at-least-once",
        "portal_ha_controls": "forbidden",
        "required_work_packages": [
            "SP-00",
            "SP-10",
            "SP-50",
    ...
    "management-readonly-local-v1": {
        ...
        "barbarossa_runtime": "go",
        "barbarossa_go_scope": "complete-implemented-capability-surface",
        "barbarossa_typescript_role": "retired-golden-vectors",
        "orchestrator": "docker-compose",
        "minimum_compose_version": "2.24.4",
        "qualification_class": "functional-smoke-only",
        "availability_class": "development-single-host",
        "barbarossa_work_transport": "nats-jetstream",
        "barbarossa_stream_replicas": 1,
        "barbarossa_state_store": "postgresql-single-node",
        "delivery_semantics": "at-least-once",
        "ha_qualified": False,
        "selected_owner_mocks": "forbidden",
        "host_binding_posture": "loopback-only",
        "minimum_image_mode_host": {
            "vcpu": 4,
            "memory_bytes": 8_000_000_000,
            "free_disk_bytes": 25_000_000_000,
        },
        "recommended_source_build_memory_bytes": 12 * 1024**3,
        "source_build_parallelism_at_minimum": "sequential",
        "required_work_packages": [
            "SP-00",
            "SP-10",
            "SP-50",
        ...
        "release_work_packages": ["SP-95", "SP-96", "SP-97", "SP-98"],
        "deferred_work_packages": [
            "SP-11",
            "SP-20",
            "SP-30",
...
REQUIRED_DEPENDENCY_EDGES = {
    ...
    "SP-92": {"SP-87", "SP-91"},
    "SP-93": {"SP-88", "SP-92"},
    "SP-94": {"SP-89", "SP-92", "SP-93"},
    "SP-95": {"SP-86"},
    "SP-96": {"SP-90", "SP-91", "SP-92"},
    "SP-97": {"SP-88", "SP-93", "SP-95", "SP-96"},
    "SP-98": {"SP-95", "SP-96", "SP-97"},
}
...
BARBAROSSA_FULL_GO_CAPABILITY_IDS = frozenset(
    {
        "SPEC-LOOP",
        "SPEC-DOM",
        "SPEC-OBS",
...
REQUIRED_PACKAGE_CONTRACTS = {
    ...
    "SP-90": {
        ("barbarossa", "capability", capability_id)
        for capability_id in BARBAROSSA_FULL_GO_CAPABILITY_IDS
    },
    "SP-91": {
        ("barbarossa", "capability", "SPEC-FED"),
        ("barbarossa", "task", "task-sp-91-distributed-work-substrate"),
    },
    "SP-92": {
        ("barbarossa", "task", "task-sp-92-high-availability-runtime-release"),
    },
    "SP-93": {
        ("platform-portal", "capability", "SPEC-CMC"),
        ("platform-portal", "task", "task-sp-93-barbarossa-ha-observability"),
    },
    "SP-94": {
        ("genai-enablement", "task", "task-sp-94-barbarossa-ha-profile-qualification"),
    },
    "SP-95": {
        ("omniscience", "capability", "SPEC-MCP"),
        ("omniscience", "capability", "SPEC-PII"),
        ("omniscience", "capability", "SPEC-MCTX"),
        ("omniscience", "task", "task-sp-95-management-readonly-local-runtime"),
    },
    "SP-96": {
        ("barbarossa", "capability", "SPEC-FED"),
        ("barbarossa", "capability", "SPEC-VIEW"),
        ("barbarossa", "task", "task-sp-96-management-readonly-local-runtime"),
    },
    "SP-97": {
        ("platform-portal", "capability", "SPEC-IT"),
        ("platform-portal", "capability", "SPEC-CV"),
        ("platform-portal", "capability", "SPEC-PII"),
        ("platform-portal", "capability", "SPEC-CMC"),
        ("platform-portal", "task", "task-sp-97-management-readonly-local-portal"),
    },
    "SP-98": {
        (
            "genai-enablement",
            "task",
            "task-sp-98-management-readonly-local-qualification",
        ),
    },
}
